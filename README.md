...
<p>The file above is the python code I’ve created to perform simple data cleansing project on a Telecommunication Company Data. The dataset is unstructured data, so I manipulate it using Pandas, Matplotlib and Seaborn, thus it provides insights.
</p>
